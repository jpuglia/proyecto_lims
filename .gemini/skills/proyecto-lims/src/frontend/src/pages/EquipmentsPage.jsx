    ...
    return (
        <AnimatedPage className="space-y-8">
            ...
            {loading ? (
                ...
                <div className="col-span-full py-16 text-center text-secondary bg-slate-50 border border-dashed border-slate-200 rounded-3xl">
                    <HardDrive className="mx-auto mb-4 text-slate-300" size={48} />
                    <p className="text-lg font-bold">No se encontraron equipos registrados.</p>
                    <p className="text-sm">Intente con otro término de búsqueda o cree uno nuevo.</p>
                </div>
            ) : (
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="bg-white rounded-3xl w-full max-w-xl shadow-2xl relative animate-in fade-in zoom-in duration-300 overflow-hidden flex flex-col max-h-[90vh]">
