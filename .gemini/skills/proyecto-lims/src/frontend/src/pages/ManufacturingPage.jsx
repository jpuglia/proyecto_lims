        ...
        <div className="space-y-4">
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="glass-card p-6 w-full max-w-lg space-y-4 flex flex-col max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
                        ...
                        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-3 overflow-y-auto pr-2">
